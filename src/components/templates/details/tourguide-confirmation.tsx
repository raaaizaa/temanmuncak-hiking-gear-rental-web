    ...
    <div className="h-screen w-full fixed bg-black/50 top-0 z-50 left-0 transition-all duration-200 ease-in flex justify-center items-center">
      <div className="bg-white h-[400px] rounded-3xl px-12 flex justify-center items-center">
        <div className="block">
          ...
          <Button className="w-full mt-12 bg-[#3F6C29] text-white font-bold" onClick={onClick}>Ya, sewa Tour Guide</Button>
          <Button className="w-full mt-4 font-bold" variant='bordered' onClick={onClose}>Batal</Button>
        </div>
      </div>
    </div>
  )
