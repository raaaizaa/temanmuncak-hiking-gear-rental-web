...
export default function MountainCard({ name, location, image }: props) {
  return (
    <Card
      className="w-[150px] h-[150px] lg:w-[250px] lg:h-[250px] xl:w-[250px] xl:h-[250px] hover:scale-110 ease-in-out duration-100"
      isPressable>
      <Image
        src={image}
        alt={name}
      ...
      <CardHeader className="absolute text-center flex bottom-0 justify-center w-full bg-gradient-to-t from-black/100 to-transparent">
        <div className="block text-white">
          <p className='text-sm lg:text-base xl:text-base font-bold'>{name}</p>
